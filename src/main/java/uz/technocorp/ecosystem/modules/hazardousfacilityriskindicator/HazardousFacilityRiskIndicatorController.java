 ...
 */
@RestController
@RequestMapping("/api/v1/hf-risk-indicator")
@RequiredArgsConstructor
public class HazardousFacilityRiskIndicatorController {

    private final HazardousFacilityRiskIndicatorService service;
