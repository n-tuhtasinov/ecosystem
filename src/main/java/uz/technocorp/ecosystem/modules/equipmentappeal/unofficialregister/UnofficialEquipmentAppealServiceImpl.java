...
public class UnofficialEquipmentAppealServiceImpl implements UnofficialEquipmentAppealService {
    ...
    @Override
    public void setHfNameAndChildEquipmentName(UnofficialEquipmentAppealDto dto) {
    ...
    @Override
    public void setRequiredFields(UnofficialAttractionDto dto) {
