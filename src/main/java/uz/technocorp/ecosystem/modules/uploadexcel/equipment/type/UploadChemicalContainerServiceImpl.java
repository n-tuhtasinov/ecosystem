 ...
 * @since v1.0
 */
@Service("CHEMICAL_CONTAINER")
@RequiredArgsConstructor
@Slf4j
public class UploadChemicalContainerServiceImpl implements UploadEquipmentExcelService {
    ...
    public void upload(MultipartFile file) {
        ...
        try (InputStream is = file.getInputStream()) {
            ...
            Sheet sheet = workbook.getSheetAt(10);                                   //TODO: Shu joyga qarash kerak
            ...
            for (int rowIndex = 2; rowIndex <= lastRowNum; rowIndex++) {
                ...
                try {
                    ...
                    String identityLatter = "AX";                                    //TODO: Shu joyga qarash kerak
                    EquipmentType equipmentType = EquipmentType.CHEMICAL_CONTAINER;              //TODO: Shu joyga qarash kerak
