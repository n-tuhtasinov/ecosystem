...
//                    getHf(dataFormatter, row, equipment, 5); // b) hfRegistryNumber
                    ...
                    getChildEquipment(dataFormatter, row, equipment, 10); // k) child equipment
                    getSphere(dataFormatter, row, equipment, 11); // sphere
                    ...
                    equipment.setType(EquipmentType.ELEVATOR); // set equipment type
    ...
    private void getSphere(DataFormatter dataFormatter, Row row, Equipment equipment, int cellIndex) throws Exception {
        String sphere = dataFormatter.formatCellValue(row.getCell(cellIndex));
        isValid(sphere, "sphere(l)");
        Sphere sphere1 = Sphere.valueOf(sphere);
        equipment.setSphere(sphere1);
    }
