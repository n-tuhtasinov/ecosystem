 ...
 * @since v1.0
 */
@Service("HEAT_PIPELINE")
@RequiredArgsConstructor
@Slf4j
public class UploadHeatPipelineServiceImpl implements UploadEquipmentExcelService {
    ...
    public void upload(MultipartFile file) {
        ...
        try (InputStream is = file.getInputStream()) {
            ...
            Sheet sheet = workbook.getSheetAt(6);                                   //TODO: Shu joyga qarash kerak
            ...
            for (int rowIndex = 2; rowIndex <= lastRowNum; rowIndex++) {
                ...
                try {
                    ...
                    String identityLatter = "PAX";                                    //TODO: Shu joyga qarash kerak
                    EquipmentType equipmentType = EquipmentType.HEAT_PIPELINE;              //TODO: Shu joyga qarash kerak
