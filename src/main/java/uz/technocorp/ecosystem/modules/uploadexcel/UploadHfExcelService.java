...
@Slf4j
public class UploadHfExcelService {
        ...
        try (InputStream is = file.getInputStream()) {
            ...
            for (int rowIndex = 1; rowIndex <= lastRowNum; rowIndex++) {
                ...
                try {
                    ...
                    getRegionAndAdress(dataFormatter, row, district, hf); // h) address
    ...
    private void getRegionAndAdress(DataFormatter dataFormatter, Row row, District district, HazardousFacility hf) throws Exception {
