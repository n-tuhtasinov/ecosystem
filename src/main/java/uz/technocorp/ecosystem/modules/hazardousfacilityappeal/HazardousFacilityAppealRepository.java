 ...
 * @since v1.0
 */
public interface HazardousFacilityAppealRepository extends JpaRepository<HazardousFacilityAppeal, UUID> {
    ...
    @Query(value = """
            ...
            where ado.id = :id
            """, nativeQuery = true)
    Optional<HazardousFacilityAppealView> getFullInfoById(UUID id);
}
