...
@Component
public class ReAccreditationPdfProcessor extends BaseAppealPdfProcessor {

    @Override
    public Class<? extends AppealDto> getSupportedType() {
        return ReAccreditationAppealDto.class;
    }

    @Override
    protected TemplateType getTemplateType() {
        return TemplateType.RE_ACCREDITATION_APPEAL;
    }
    ...
    protected Map<String, String> buildParameters(AppealDto appealDto, Profile profile) {
        ReAccreditationAppealDto dto = (ReAccreditationAppealDto) appealDto;
