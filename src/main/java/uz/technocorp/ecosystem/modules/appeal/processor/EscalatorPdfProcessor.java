...
import uz.technocorp.ecosystem.modules.equipmentappeal.dto.EscalatorDto;
...
@Component
public class EscalatorPdfProcessor extends BaseAppealPdfProcessor {

    @Override
    public Class<? extends AppealDto> getSupportedType() {
        return EscalatorDto.class;
    }
