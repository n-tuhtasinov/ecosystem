...
@Component
public class ContainerPdfProcessor extends BaseAppealPdfProcessor {

    @Override
    public Class<? extends AppealDto> getSupportedType() {
        return ContainerDto.class;
    }
