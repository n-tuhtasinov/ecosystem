...
import uz.technocorp.ecosystem.modules.equipmentappeal.dto.LpgPoweredDto;
...
@Component
public class LpgPoweredPdfProcessor extends BaseAppealPdfProcessor {

    @Override
    public Class<? extends AppealDto> getSupportedType() {
        return LpgPoweredDto.class;
    }
