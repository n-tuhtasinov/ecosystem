...
import uz.technocorp.ecosystem.modules.equipmentappeal.dto.ChemicalContainerDto;
...
@Component
public class ChemicalContainerPdfProcessor extends BaseAppealPdfProcessor {

    @Override
    public Class<? extends AppealDto> getSupportedType() {
        return ChemicalContainerDto.class;
    }
    ...
    protected String folderPath() {
        return "appeals/chemical-container";
    }

    @Override
    protected Map<String, String> buildParameters(AppealDto appealDto, Profile profile) {
        ChemicalContainerDto dto = (ChemicalContainerDto) appealDto;
