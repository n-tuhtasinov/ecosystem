...
@Component
public class BoilerUtilizerPdfProcessor extends BaseAppealPdfProcessor {

    @Override
    public Class<? extends AppealDto> getSupportedType() {
        return BoilerUtilizerDto.class;
    }
    ...
    protected String folderPath() {
        return "appeals/boiler-utilizer";
    }

    @Override
    protected Map<String, String> buildParameters(AppealDto appealDto, Profile profile) {
        BoilerUtilizerDto dto = (BoilerUtilizerDto) appealDto;
