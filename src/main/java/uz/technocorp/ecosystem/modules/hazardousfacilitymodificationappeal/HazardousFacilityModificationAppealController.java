...
//
//    @PostMapping
//    public ResponseEntity<?> create(@CurrentUser User user, @Valid @RequestBody HfModificationAppealDto dto) {
//        try {
...
//
//    @PutMapping("/{id}")
//    public ResponseEntity<?> update(@PathVariable UUID id, @Valid @RequestBody HfModificationAppealDto dto) {
