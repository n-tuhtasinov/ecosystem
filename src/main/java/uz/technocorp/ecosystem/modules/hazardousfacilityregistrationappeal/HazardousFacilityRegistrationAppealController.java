...
//    public ResponseEntity<?> create(@CurrentUser User user, @Valid @RequestBody HfAppealDto dto, BindingResult result) {
...
//
//    @PutMapping("/{id}")
//    public ResponseEntity<?> update(@PathVariable UUID id, @Valid @RequestBody HfAppealDto dto) {
