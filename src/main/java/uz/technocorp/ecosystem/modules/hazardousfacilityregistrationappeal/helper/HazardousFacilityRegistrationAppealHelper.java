package uz.technocorp.ecosystem.modules.hazardousfacilityregistrationappeal.helper;
 ...
 * @since v1.0
 */
public record HazardousFacilityRegistrationAppealHelper(HazardousFacilityRegistrationAppealView object, List<AppealExecutionProcessProjection> executionProcessList, List<DocumentProjection> documentProjections) {
}
